...
if (event_type === 'wallet_connect') {
  log('wallet_address =', params.wallet_address);
  callInWindow('spindl.attribute', params.wallet_address);
}
...
- name: wallet test 1
  code: "const mockData = {\n  event_type: \"wallet_connect\",\n  properties: [{\n\
    \    property_key: \"wallet_address\",\n    property_value: \"0x000...\"\n  }]\
...
Created on 8/19/2024, 2:01:48 PM
